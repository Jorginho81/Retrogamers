    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('titre', null, [
                ...
                'help' => 'Le titre du produit doit être compris entre 2 et 40 caractères',
                'help_attr' => [
            ...
            ->add('imageFile', FileType::class, [
                ...
                'mapped' => false,   // N'est pas mappé directement sur une propriété de l'entité
                'attr' => [
                    'accept' => 'image/*', // Filtrez les types de fichiers autorisés (images uniquement ici)
                ],
            ])
            ->add('description', null, [
                ...
                'help' => 'La description du produit doit contenir moins de 1500 caractères',
                'help_attr' => [
                    'class' => 'text-primary fst-italic'
                ],
                'row_attr' => [
                ...
                'constraints' => [
                    new Length([
                        'max' => 1500,
                        'maxMessage' => 'Veuillez saisir une description de moins de 1500 caractères'
                    ])
                ]
            ])
            ...
            // ->add('image_uri', HiddenType::class, [
            //     'mapped' => false, // Ne sera pas utilisé pour hydrater l'entité
            //     'data' => 'L\'URL de votre image ici', // Remplacez par la vraie URL si disponible
            //     'attr' => [
            //         'class' => 'image-uri-hidden', // Ajoutez une classe CSS si nécessaire
            //     ],
            // ]);
