...
{
/**
     * @Route("/fiche/{id}", name="front_produit_fiche")
     */                                     
    ...
    #[Route('/front', name: 'cgv_route')]
                                   
    public function cgv(PagesAdminRepository $pagesAdminRepository): Response
    {
        $cgv = $pagesAdminRepository->findOneByTitre('CGV');
    ...
    public function mentionsLegales(PagesAdminRepository $pagesAdminRepository): Response
    {
        $mentionsLegales = $pagesAdminRepository->findOneByTitre('Mentions Légales');
